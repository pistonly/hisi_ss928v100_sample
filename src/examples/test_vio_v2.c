...
td_s32 main(td_s32 argc, td_char *argv[]) {
  ...
  sample_vi_get_default_vb_config(&in_size, &vb_cfg, video_mode,
                                  VB_DOUBLE_YUV_CNT, VB_WDR_RAW_CNT);
  ...
  if (ret != TD_SUCCESS) {
    sample_svp_trace_err("sample_comm_sys_init_with_vb_supplement error!");
    return 1;
  }
  ...
  vi_cfg[1].grp_info.fusion_grp[1] = 1;
